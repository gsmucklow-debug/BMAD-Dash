...
"""
        ...
        assert gap['suggested_command'] == 'npx bmad-method run dev-story', "Gap should suggest dev-story command"
...
"""
        ...
        assert gap['suggested_command'] == 'npx bmad-method run code-review', "Gap should suggest code-review command"
